    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-[9990] flex items-center gap-3 px-5 py-3 rounded-full bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 text-white font-semibold shadow-2xl hover:shadow-3xl transition"
      ...
      {open && (
        <div className="fixed bottom-6 right-6 z-[9990] w-[92vw] max-w-[420px]">
