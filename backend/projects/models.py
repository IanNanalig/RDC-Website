...
class Project(models.Model):
    ...
    ai_priority_level = models.CharField(max_length=20, null=True, blank=True)
    ai_analysis_notes = models.TextField(blank=True, default="")
...
class AIProjectScoreReview(models.Model):
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name="ai_score_reviews")
    ...
    def __str__(self):
        return f"{self.project_id} {self.score} {self.grade}"
